...
function TermsAndConditions() {
  return (
    <div className={classes.container}>
      ...
      <p>
        Welcome to Diamed! These terms and conditions
      ...
      <p>
        ...
        [Your Website Name] if you do not agree to take all
        of the terms and conditions stated on this page.
      </p>

      <h2>2. Intellectual Property Rights</h2>
      <p>
        Unless otherwise stated, Diamed and/or its licensors
        own the intellectual property rights for all
        material on [Your Website Name]. All intellectual
      ...
      <p>
        ...
        to post and exchange opinions and information.
        Diamed does not filter, edit, publish or review
        Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of
        Diamed, its agents and/or affiliates. Comments
      ...
      <p>
        You may link to our home page, to publications or to
        other Website information so long as the link: (a)
        is not in any way deceptive; (b) does not falsely
        imply sponsorship, endorsement or approval of the
      ...
      <p>
        ...
        the state and federal courts located in Germany for
      ...
      <p>
        ...
        please contact us at diamed.testkit@gmail.com.
      </p>
    </div>
  );
}
